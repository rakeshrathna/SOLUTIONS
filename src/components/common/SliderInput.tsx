...
export const SliderInput: React.FC<SliderInputProps> = ({
  ...
  return (
    <div className="flex flex-col gap-4 p-5 md:p-6 rounded-2xl bg-slate-50/90 border border-slate-200 hover:border-cyan-500/50 transition-all duration-200 shadow-xs">
      ...
      <div className="flex items-center justify-between gap-3 flex-wrap sm:flex-nowrap">
        ...
        <div className="flex items-center gap-2 font-mono shrink-0">
          ...
          {unit && (
            <span className="text-xs font-semibold text-slate-600 font-mono bg-white px-2.5 py-1.5 rounded-lg border border-slate-200 shadow-2xs">
              {unit}
            </span>
          )}
        </div>
      ...
      {description && (
        <p className="text-xs text-slate-500 italic bg-white/70 px-3 py-2 rounded-lg border border-slate-200/60 leading-relaxed">
          {description}
        </p>
      )}
      ...
      <div className="space-y-2.5 pt-1">
        ...
        <div className="flex items-center justify-between text-xs text-slate-400 font-mono pt-0.5">
          <button
            ...
            className="px-2.5 py-1 rounded-md bg-white border border-slate-200 hover:border-cyan-400 hover:text-cyan-700 transition-all cursor-pointer shadow-2xs"
