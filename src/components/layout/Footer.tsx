    ...
    <footer className="w-full bg-white border-t border-slate-200/80 mt-auto py-6">
      <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-bold text-slate-800 tracking-tight">EDUiDEAL ACADEMY</span>
            <span className="mx-2 text-slate-300">•</span>
            <span className="text-slate-600">CBSE Class 12 Chemistry — Solutions</span>
          </div>
        </div>

        <div className="flex items-center gap-4 text-[11px] font-medium text-slate-500">
          <span className="flex items-center gap-1.5">
            <BookOpen className="w-3.5 h-3.5 text-[#15009A]" /> Education For Life
          </span>
          <span className="text-slate-300">•</span>
          <span>© 2026 EDUiDEAL ACADEMY</span>
        </div>
      </div>
    </footer>
  );
