...
export const subjectsData: Subject[] = [
  {
    ...
    name: 'Chemistry',
    badge: 'Class 12 CBSE',
    description: 'Explore Class 12 Chemistry through interactive concepts, formula visualizations, dynamic graphs, revision notes, and topic-wise practice questions.',
  ...
  },
  {
    ...
    name: 'Physics',
    badge: 'Class 12 CBSE',
    description: 'Learn Class 12 Physics through interactive concepts, formulas, visual simulations, graphs, and practice questions.',
    iconName: 'Zap',
    status: 'COMING_SOON',
    lessonsCount: 14,
  ...
  },
  {
    ...
    name: 'Mathematics',
    badge: 'Class 12 CBSE',
    description: 'Master Class 12 Mathematics with interactive concepts, formula exploration, visual explanations, and topic-wise practice.',
    iconName: 'Calculator',
    status: 'COMING_SOON',
    lessonsCount: 13,
    activeLessonsCount: 0,
